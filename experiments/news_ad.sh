...
sentencify.py -i ../data/raw/kaggle1 -o ../data/cache/kaggle1_sentences.dat --overwrite
word2vec.py -i ../data/cache/kaggle1_sentences.dat -o ../data/cache/kaggle1_w2v_model --overwrite

preprocess_kaggle.py -i ../data/raw/kaggle1 -o ../data/cache/kaggle1_preprocessed.dat -c 10000 --overwrite
